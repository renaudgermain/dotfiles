...
(require 'package)
(setq gnutls-algorithm-priority "NORMAL:-VERS-TLS1.3") ;; https://debbugs.gnu.org/cgi/bugreport.cgi?bug=34341
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (dockerfile-mode haskell-emacs scala-mode yaml-mode fish-mode markdown-mode haskell-mode go-mode))))

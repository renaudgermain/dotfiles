...
(custom-set-variables
 ...
 '(package-selected-packages
   '(powershell typescript-mode json-mode magit pip-requirements go-mode protobuf-mode idle-highlight-mode helm flycheck groovy-mode lsp-mode lsp-java eglot terraform-mode apples-mode mustache mustache-mode dockerfile-mode java-imports yaml-mode scala-mode feature-mode markdown-mode jdecomp)))
(custom-set-faces
